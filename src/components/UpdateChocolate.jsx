    ...
    return (
        <div className='add-container'>
            ...
            <div className='add-form'>
                ...
                <form onSubmit={handleUpdateChocolate} className='form'>
                    <label htmlFor="name">
                        <p>Name</p>
                        <input defaultValue={name} placeholder='Hot Pink Chocolate' type="text" name="name" id="name" required />
                    </label>
                    <label htmlFor="country">
                        <p>country</p>
                        <input defaultValue={country} placeholder='Enter Country Name' type="text" name="country" id="country" required />
                    </label>
                    <label htmlFor="PhotoUrl">
                        <p>Photo Url</p>
                        <input defaultValue={photo} placeholder='Enter PhotoUrl ' type="text" name="photo" id="PhotoUrl" required />
                    </label>
